...
) ENGINE=MyISAM AUTO_INCREMENT=8451 DEFAULT CHARSET=latin1 COLLATE=latin1_bin ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=156 DEFAULT CHARSET=latin1 COLLATE=latin1_bin ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=407 DEFAULT CHARSET=latin1 COLLATE=latin1_bin ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=2150 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=968519 DEFAULT CHARSET=latin1 COLLATE=latin1_bin MAX_ROWS=100000000 AVG_ROW_LENGTH=80 ROW_FORMAT=DYNAMIC;
