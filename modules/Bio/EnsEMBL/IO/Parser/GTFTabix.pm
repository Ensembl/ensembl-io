...
Bio::EnsEMBL::IO::Parser::GTFTabix - Parses tabix-indexed GTF files
...
package Bio::EnsEMBL::IO::Parser::GTFTabix;
...
sub open {
  ...
  if($self->{'params'}->{'must_parse_metadata'}) {
    ...
    foreach my $line (split("\n",$tabix_data || '')) {
      ...
      $self->Bio::EnsEMBL::IO::Parser::GTF::read_metadata();
    }
...
sub read_record {
  my $self = shift;
  $self->Bio::EnsEMBL::IO::Parser::GTF::read_record(@_);
}
